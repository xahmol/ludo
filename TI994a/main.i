...
void graphicsinit()
{
    ...
    ferr = dsr_load("DSK1.LUDOCHR",musicmem,1600);
    if (ferr) { fileerrormessage(ferr); halt(); }
    vdpmemcpy(gPattern,musicmem,1600);


    ferr = dsr_load("DSK1.LUDOCOL",musicmem,25);
    if (ferr) { fileerrormessage(ferr); halt(); }
    vdpmemcpy(gColor,musicmem,25);


    ferr = dsr_load("DSK1.LUDOMSC",mainscreen,768);
    if (ferr) { fileerrormessage(ferr); halt(); }


    ferr = dsr_load("DSK1.LUDOTIT",musicmem,576);
    if (ferr) { fileerrormessage(ferr); halt(); }
...
void informationcredits()
{
    ...
    unsigned char version[30] = {
        'v','1','9','9',' ','-',' ',
        ("Apr  1 2021"[ 7]),("Apr  1 2021"[ 8]),("Apr  1 2021"[ 9]),("Apr  1 2021"[10]),
        ((("Apr  1 2021"[0] == 'O') || ("Apr  1 2021"[0] == 'N') || ("Apr  1 2021"[0] == 'D')) ? '1' : '0'),( (("Apr  1 2021"[0] == 'J' && "Apr  1 2021"[1] == 'a' && "Apr  1 2021"[2] == 'n')) ? '1' : (("Apr  1 2021"[0] == 'F')) ? '2' : (("Apr  1 2021"[0] == 'M' && "Apr  1 2021"[1] == 'a' && "Apr  1 2021"[2] == 'r')) ? '3' : (("Apr  1 2021"[0] == 'A' && "Apr  1 2021"[1] == 'p')) ? '4' : (("Apr  1 2021"[0] == 'M' && "Apr  1 2021"[1] == 'a' && "Apr  1 2021"[2] == 'y')) ? '5' : (("Apr  1 2021"[0] == 'J' && "Apr  1 2021"[1] == 'u' && "Apr  1 2021"[2] == 'n')) ? '6' : (("Apr  1 2021"[0] == 'J' && "Apr  1 2021"[1] == 'u' && "Apr  1 2021"[2] == 'l')) ? '7' : (("Apr  1 2021"[0] == 'A' && "Apr  1 2021"[1] == 'u')) ? '8' : (("Apr  1 2021"[0] == 'S')) ? '9' : (("Apr  1 2021"[0] == 'O')) ? '0' : (("Apr  1 2021"[0] == 'N')) ? '1' : (("Apr  1 2021"[0] == 'D')) ? '2' : '?' ),(("Apr  1 2021"[4] >= '0') ? ("Apr  1 2021"[4]) : '0'),("Apr  1 2021"[ 5]),'-',
        ("09:28:36"[0]),("09:28:36"[1]),("09:28:36"[3]),("09:28:36"[4]) };
...
int main()
{
    ...
    if(musicnumber) { StopSong(); MUTE_SOUND(); }
    halt();
}
